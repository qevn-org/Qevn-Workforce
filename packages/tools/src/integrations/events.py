...
class NormalizedEvent(BaseModel):
    ...
    event_type: str = Field(description="Normalized type classification e.g. email.received")
    connector_id: str = Field(description="Identifier of the source connector e.g. gmail")
    ...
    payload: Dict[str, Any] = Field(default_factory=dict, description="Normalized context metadata payload details")
